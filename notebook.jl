...
# ╔═╡ b52974a6-5df0-4042-b785-151f7679c98e
begin
	using DataFrames
	using CSV
end

# ╔═╡ 9c5deed8-61d0-4358-b98d-993616882b5b
using PlutoUI

# ╔═╡ b6e09120-dfae-11ef-15b9-f5583567ff67
println("Hello, World!")

# ╔═╡ 85471194-789d-4287-9946-f75db15dd912
begin
	hello(x) = println("Hello, $(x)!")
	hello("Stackie")
end

# ╔═╡ b3578f90-3683-49ba-9d5a-ab1a9444c45d
df = CSV.read("WHO-COVID-19-global-data.csv", DataFrame)

# ╔═╡ 60c402b5-92e1-4ece-9fff-9934710fa530
df.Country_code === df[!, "Country_code"]

# ╔═╡ 62c8500e-aae0-4004-ba61-1563569a1c81
equals_sg(x::AbstractString) = x == "SG"

# ╔═╡ 3c5c62ad-9410-4f47-9e3c-9e3cbd9f122a
...
# ╔═╡ bb360bbc-e9bd-48e3-bc0c-ac6f80794a40
cumulative_data_plotted_over_date = plot(dates, cumulative_cases)

# ╔═╡ 2bea23ef-7211-4ce4-ac2e-a7b4c8b5ae7d
...
# ╔═╡ fbb93d00-5b44-4bb9-bfc9-01ba68093ccb
@bind slider_value Slider(0:10:1000)

# ╔═╡ 8ee9ec61-0b66-4286-8605-3a4134da606e
md"""
### Slider Value Now At $(slider_value)
"""

# ╔═╡ 7dfa3340-cbe5-48ee-8bae-3686c238790e
@bind date_slider_index Slider(1:length(dates))

# ╔═╡ 0e2090d2-a84e-442f-a2a4-c9557d4a7129
md"""
### The date is now $(dates[date_slider_index])
"""

# ╔═╡ 14238c9a-82fe-4b76-b9d6-8767cbaca6c1
...
# ╠═b6e09120-dfae-11ef-15b9-f5583567ff67
# ╠═85471194-789d-4287-9946-f75db15dd912
# ╠═8af9a0cb-38e2-47c6-aa55-c6fc7932f264
# ╠═b3578f90-3683-49ba-9d5a-ab1a9444c45d
# ╠═60c402b5-92e1-4ece-9fff-9934710fa530
# ╠═62c8500e-aae0-4004-ba61-1563569a1c81
# ╠═3c5c62ad-9410-4f47-9e3c-9e3cbd9f122a
